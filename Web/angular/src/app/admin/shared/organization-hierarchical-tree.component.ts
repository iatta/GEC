...
export interface IOrganizationUnitsHierarchicalTreeComponentData {
...
@Component({
    selector: 'organization-unit-hierarchical-tree',
    templateUrl: './organization-hierarchical-tree.component.html'

})
export class OrganizationHierarchicalTreeComponent extends AppComponentBase {

    @Input() cascadeSelectEnabled = true;

    set data(data: IOrganizationUnitsHierarchicalTreeComponentData) {
