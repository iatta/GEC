...
export interface IOrganizationUnitsHorizontalTreeComponentData {
    allOrganizationUnits: OrganizationUnitDto[];
    selectedOrganizationUnits: string[];
}

@Component({
    selector: 'organization-unit-horizontal-tree',
    template:
...
export class OrganizationUnitsHorizontalTreeComponent extends AppComponentBase {

    @Input() cascadeSelectEnabled = true;

    set data(data: IOrganizationUnitsHorizontalTreeComponentData) {
