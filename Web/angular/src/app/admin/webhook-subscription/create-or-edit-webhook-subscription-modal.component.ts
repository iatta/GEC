...
export class CreateOrEditWebhookSubscriptionModalComponent extends AppComponentBase {
    ...
    @ViewChild('additionalHeaderKey', { static: false }) additionalHeaderKey: ElementRef;
    @ViewChild('additionalHeaderValue', { static: false }) additionalHeaderValue: ElementRef;
