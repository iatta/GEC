...
namespace GEC.Attendance.Test.Base.DependencyInjection
{
    public static class ServiceCollectionRegistrar
    {
        public static void Register(IIocManager iocManager)
        {
            ...
            iocManager.IocContainer.Register(
                Component
                    .For<DbContextOptions<AttendanceDbContext>>()
            ...
            new AttendanceDbContext(builder.Options).Database.EnsureCreated();
        }
