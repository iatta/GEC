...
namespace Pixel.GEC.Attendance.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = AttendanceConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(AttendanceDbContext context)
        {
            _context = context;
        }
