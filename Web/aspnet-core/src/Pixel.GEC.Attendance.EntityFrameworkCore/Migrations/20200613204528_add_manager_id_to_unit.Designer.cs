...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Attendance.MobileTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Attendance.UserDevice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Authorization.Users.UserLocation", b =>
                {
                    b.Property<long>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Operation.EmployeeAbsence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Operations.EmployeeOfficialTaskDetail", b =>
                {
                    b.Property<long?>("UserId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Operations.EmployeeWarning", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Operations.ManualTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Operations.Tran", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.ReportsModel.EmployeeReportCore", b =>
                {
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.ReportsModel.FingerReportCore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.ReportsModel.ForgetInOutCore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.ReportsModel.InOutReportOutputCore", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.ReportsModel.PermitReportCore", b =>
                {
                    b.Property<int>("PermitId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Setting.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Setting.LocationCredential", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Setting.Nationality", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Setting.TempTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Settings.MobileWebPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Extended.OrganizationUnitExtended", b =>
                {
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Authorization.Users.User", b =>
                {
                    ...
                    b.HasOne("Pixel.GEC.Attendance.Setting.Nationality", "Nationality")
                        .WithMany()
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Authorization.Users.UserLocation", b =>
                {
                    b.HasOne("Pixel.GEC.Attendance.Setting.Location", "Location")
                        .WithMany()
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Pixel.GEC.Attendance.Authorization.Users.User", "User")
                        .WithMany("Locations")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Operations.EmployeeOfficialTaskDetail", b =>
                {
                    b.HasOne("Pixel.GEC.Attendance.Operations.EmployeeOfficialTask", "EmployeeOfficialTaskFk")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Operations.EmployeeWarning", b =>
                {
                    ...
                    b.HasOne("Pixel.GEC.Attendance.Setting.WarningType", "WarningTypeFk")
                        .WithMany()
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Setting.LocationCredential", b =>
                {
                    b.HasOne("Pixel.GEC.Attendance.Setting.Location", "LocationFk")
            ...
            modelBuilder.Entity("Pixel.GEC.Attendance.Extended.OrganizationUnitExtended", b =>
                {
                    b.HasOne("Pixel.GEC.Attendance.Authorization.Users.User", "Manager")
                        .WithMany()
