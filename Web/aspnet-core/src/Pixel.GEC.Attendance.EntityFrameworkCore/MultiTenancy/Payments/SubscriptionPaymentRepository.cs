...
{
    public class SubscriptionPaymentRepository : AttendanceRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<AttendanceDbContext> dbContextProvider)
