...
namespace Pixel.GEC.Attendance.Core.Base
{
    public abstract class AttendanceQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected AttendanceQueryBase(string fieldName,
