...
namespace Pixel.GEC.Attendance.Web.TagHelpers
{
    [HtmlTargetElement("script", Attributes = AbpSrcAttributeName)]
    public class AttendanceScriptSrcTagHelper : TagHelper
    {
        ...
        public AttendanceScriptSrcTagHelper(IWebHostEnvironment hostingEnvironment, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
                ...
                output.Attributes[AbpSrcAttributeName].Value is string)
            {
                ...
                if (!(href.IndexOf(".min.js", StringComparison.InvariantCultureIgnoreCase) >= 0) && href.IndexOf(".js", StringComparison.InvariantCultureIgnoreCase) >= 0)
                {
