(function () {
    $(function () {
        ...
        var _entityTypeFullName = 'Pixel.GEC.Attendance.Authorization.Roles.Role';
                ...
                },
                {
                    ...
                    render: function (displayName, type, row, meta) {
                        ...
                        if (row.isStatic) {
                            $span.append(
                                $("<span/>")
                                    .addClass("kt-badge kt-badge--brand kt-badge--inline")
                        ...
                        if (row.isDefault) {
                            $span.append(
                                $("<span/>")
                                    .addClass("kt-badge kt-badge--dark kt-badge--inline")
                                    .attr("data-toggle", "kt-tooltip")
