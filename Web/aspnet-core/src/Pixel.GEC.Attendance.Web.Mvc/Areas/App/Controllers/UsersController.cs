...
using Pixel.GEC.Attendance.Web.Areas.App.Models.Roles;
using Pixel.GEC.Attendance.Web.Areas.App.Models.Users;
...
namespace Pixel.GEC.Attendance.Web.Areas.App.Controllers
{
    ...
    public class UsersController : AttendanceControllerBase
    {
