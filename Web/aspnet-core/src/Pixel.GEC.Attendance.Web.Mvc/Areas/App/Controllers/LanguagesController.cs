...
using Pixel.GEC.Attendance.Web.Areas.App.Models.Languages;
...
namespace Pixel.GEC.Attendance.Web.Areas.App.Controllers
{
    ...
    public class LanguagesController : AttendanceControllerBase
    {
            ...
            string filterText = "")
        {
            ...
            {
                sourceName = AttendanceConsts.LocalizationSourceName;
            }
