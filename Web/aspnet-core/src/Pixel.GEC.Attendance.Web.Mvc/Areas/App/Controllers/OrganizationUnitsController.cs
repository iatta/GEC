...
using Pixel.GEC.Attendance.Web.Areas.App.Models.Common.Modals;
using Pixel.GEC.Attendance.Web.Areas.App.Models.OrganizationUnits;
...
namespace Pixel.GEC.Attendance.Web.Areas.App.Controllers
{
    ...
    public class OrganizationUnitsController : AttendanceControllerBase
    {
