...
namespace Pixel.GEC.Attendance.Web.Areas.App.Views.Shared.Components.AppTheme12Footer
{
    public class AppTheme12FooterViewComponent : AttendanceViewComponent
    {
