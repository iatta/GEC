...
using Pixel.GEC.Attendance.Web.Areas.App.Startup;
using Pixel.GEC.Attendance.Web.Views;

namespace Pixel.GEC.Attendance.Web.Areas.App.Views.Shared.Components.AppMenu
{
    public class AppMenuViewComponent : AttendanceViewComponent
    {
