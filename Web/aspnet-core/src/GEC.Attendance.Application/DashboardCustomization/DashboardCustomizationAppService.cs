...
using GEC.Attendance.DashboardCustomization.Definitions;
using GEC.Attendance.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace GEC.Attendance.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : AttendanceAppServiceBase, IDashboardCustomizationAppService
    {
