...
using GEC.Attendance.UiCustomization;

namespace GEC.Attendance.Sessions
{
    public class SessionAppService : AttendanceAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = AttendanceConsts.Currency,
                    CurrencySign = AttendanceConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = AttendanceConsts.AllowTenantsToChangeEmailSettings
                }
            };
