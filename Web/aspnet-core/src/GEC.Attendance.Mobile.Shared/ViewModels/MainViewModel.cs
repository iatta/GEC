...
using MvvmHelpers;
using GEC.Attendance.Authorization.Users.Profile;
using GEC.Attendance.Authorization.Users.Profile.Dto;
using GEC.Attendance.Commands;
using GEC.Attendance.Core.Threading;
using GEC.Attendance.Models.NavigationMenu;
using GEC.Attendance.Services.Navigation;
using GEC.Attendance.ViewModels.Base;
using Plugin.Media;
...
using GEC.Attendance.ApiClient;
using GEC.Attendance.Controls;
using GEC.Attendance.Dto;
using GEC.Attendance.Extensions;
using GEC.Attendance.Localization;
using GEC.Attendance.UI;
using GEC.Attendance.UI.Assets;
using GEC.Attendance.Views;
using DependencyResolver = GEC.Attendance.Core.Dependency.DependencyResolver;

namespace GEC.Attendance.ViewModels
{
