...
namespace Pixel.GEC.Attendance.MultiTenancy.Payments.Stripe
{
    public class StripeGatewayManager : AttendanceServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Attendance";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + AttendanceConsts.Currency;
        }
