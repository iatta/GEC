...
using Pixel.GEC.Attendance.ApiClient;
using Pixel.GEC.Attendance.Controls;
using Pixel.GEC.Attendance.Dto;
using Pixel.GEC.Attendance.Extensions;
using Pixel.GEC.Attendance.Localization;
using Pixel.GEC.Attendance.UI;
using Pixel.GEC.Attendance.UI.Assets;
using Pixel.GEC.Attendance.Views;
using DependencyResolver = Pixel.GEC.Attendance.Core.Dependency.DependencyResolver;
