...
namespace Pixel.GEC.Attendance.Web.Public.Startup
{
    [DependsOn(
        typeof(AttendanceWebCoreModule)
    )]
    public class AttendanceWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public AttendanceWebFrontEndModule(IWebHostEnvironment env, AttendanceEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AttendanceWebFrontEndModule).GetAssembly());
        }
    }
}
