...
using Pixel.GEC.Attendance.Web.Public.Startup;
using Pixel.GEC.Attendance.Web.Session;

namespace Pixel.GEC.Attendance.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : AttendanceViewComponent
    {
