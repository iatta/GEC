...
using GEC.Attendance.MultiTenancy.Demo;
...
namespace GEC.Attendance.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(AttendanceConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
