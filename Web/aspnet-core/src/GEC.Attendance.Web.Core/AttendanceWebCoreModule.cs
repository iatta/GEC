...
using GEC.Attendance.Web.Chat.SignalR;
using GEC.Attendance.Web.Configuration;
using GEC.Attendance.Web.DashboardCustomization;

namespace GEC.Attendance.Web
{
    [DependsOn(
    ...
    public class AttendanceWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AttendanceWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(AttendanceApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AttendanceWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(AttendanceWebCoreModule).Assembly);
        }
