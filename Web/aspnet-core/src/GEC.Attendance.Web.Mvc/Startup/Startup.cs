...
using GEC.Attendance.Schemas;
using GEC.Attendance.Web.Chat.SignalR;
using GEC.Attendance.Web.Common;
using GEC.Attendance.Web.Resources;
using PaulMiami.AspNetCore.Mvc.Recaptcha;
using GEC.Attendance.Web.IdentityServer;
using GEC.Attendance.Web.Swagger;
using Stripe;
...
using GEC.Attendance.Web.HealthCheck;
            ...
            if (WebConsts.SwaggerUiEnabled)
            {
                ...
                app.UseSwaggerUI(options =>
                {
                    ...
                    options.IndexStream = () => Assembly.GetExecutingAssembly()
                        .GetManifestResourceStream("GEC.Attendance.Web.wwwroot.swagger.ui.index.html");
