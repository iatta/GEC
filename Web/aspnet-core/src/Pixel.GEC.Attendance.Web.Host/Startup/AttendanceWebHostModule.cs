...
namespace Pixel.GEC.Attendance.Web.Startup
{
    ...
    public class AttendanceWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public AttendanceWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(AttendanceWebHostModule).GetAssembly());
        }
