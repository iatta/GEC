...
using Pixel.GEC.Attendance.Web.Models.Consent;

namespace Pixel.GEC.Attendance.Web.Host.Controllers
{
    public class ConsentController : AttendanceControllerBase
    {
