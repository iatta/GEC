...
namespace Pixel.GEC.Attendance.Web.Authentication.JwtBearer
{
    public class AttendanceJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public AttendanceJwtSecurityTokenHandler()
        {
