...
using Pixel.GEC.Attendance.DemoUiComponents.Dto;

namespace Pixel.GEC.Attendance.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : AttendanceAppServiceBase, IDemoUiComponentsAppService
    {
