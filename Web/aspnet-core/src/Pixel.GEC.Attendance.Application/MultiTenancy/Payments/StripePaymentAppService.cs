...
using Pixel.GEC.Attendance.MultiTenancy.Payments.Stripe;
using Pixel.GEC.Attendance.MultiTenancy.Payments.Stripe.Dto;
using Stripe;
using Stripe.Checkout;

namespace Pixel.GEC.Attendance.MultiTenancy.Payments
{
    public class StripePaymentAppService : AttendanceAppServiceBase, IStripePaymentAppService
    {
