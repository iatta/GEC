...
@Component({
    selector: 'projectUserLookupTableModal',
    styleUrls: ['./project-user-lookup-table-modal.component.less'],
    encapsulation: ViewEncapsulation.None,
    templateUrl: './project-user-lookup-table-modal.component.html'
})
export class ProjectUserLookupTableModalComponent extends AppComponentBase {
    ...
    setAndSave(user: ProjectUserLookupTableDto) {
        this.id = user.id;
