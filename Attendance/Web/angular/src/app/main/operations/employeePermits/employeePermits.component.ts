...
import { EmployeePermitsServiceProxy, EmployeePermitDto  } from '@shared/service-proxies/service-proxies';
...
@Component({
    templateUrl: './employeePermits.component.html',
    encapsulation: ViewEncapsulation.None,
    animations: [appModuleAnimation()]
})
export class EmployeePermitsComponent extends AppComponentBase {
    ...
    getEmployeePermits(event?: LazyLoadEvent) {
        ...
        this._employeePermitsServiceProxy.getAll(
            this.filterText,
