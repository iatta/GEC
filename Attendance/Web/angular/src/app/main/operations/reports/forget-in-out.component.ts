...
@Component({
    selector: 'forget-in-out-component',
    templateUrl: './forget-in-out.component.html',
    styles: [`
    .vacation {
...
export class ForgetInOutComponent extends AppComponentBase implements OnInit {

    defaultLogo = '';
    reportList:InOutReportOutput[] = [];
    rowGroupMetadata: any;
    show = false;
    reportName = 'تقرير  نسيان دخول / خروج  ';
