...
@Component({
    templateUrl: './normal-overtime.component.html',
    styleUrls:['./normal-overtime.component.css']
})

export class NormalOvertimeComponent extends AppComponentBase implements OnInit {
    ...
    generateReport(){
        this._transactionService.getNormalOverTime(this.fromDate,this.toDate).subscribe((result) => {
            console.log(result);
