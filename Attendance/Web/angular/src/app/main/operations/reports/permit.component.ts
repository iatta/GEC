...
import { PermitReportOutput } from './../../../../shared/service-proxies/service-proxies';
import { Component, OnInit, Injector, Input } from '@angular/core';
import * as moment from 'moment';

@Component({
    selector: 'permit-report-component',
...
export class PermitReportComponent extends AppComponentBase implements OnInit {

    defaultLogo = '';
    reportList:PermitReportOutput[] = [];
    rowGroupMetadata: any;
    show = false;
    reportName = 'تقرير الأذونات ';
    ...
    constructor(injector: Injector) {
     ...
     setData(data: PermitReportOutput[] , fromDate:moment.Moment , toDate:moment.Moment){
    ...
    getTotalPermit(rowData: any){
        return rowData.toTime - rowData.fromTime;
    }
    ...
    exportExcel() {
        let new_list = this.reportList.map(function(obj) {
            return {
              date : moment(obj.date).format('YYYY-MM-DD').toString(),
              fromTime: obj.toTime,
              toTime: obj.fromTime
            }
          });
