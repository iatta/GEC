...
export class RegularHoursComponent extends AppComponentBase implements OnInit {
    ...
    generateReport(){
        ...
        this.data =[];
        this._transactionService.getRegularHours(this.fromDate,this.toDate).subscribe((result) => {
            console.log(result);
    ...
    exportExcel() {
        import("xlsx").then(xlsx => {
            ...
            this.saveAsExcelFile(excelBuffer, "RegularHours");
        });
    }
