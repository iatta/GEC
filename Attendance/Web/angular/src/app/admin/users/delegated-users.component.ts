import { NotificaionInput, PagedResultDtoOfDelegatedUserListDto ,DelegatedUserListDto} from '../../../shared/service-proxies/service-proxies';
...
export class DelegatedUsersComponent extends AppComponentBase implements AfterViewInit {
    ...
    getUsers(event?: LazyLoadEvent) {
        ...
        this._userServiceProxy.getDelegatedUsers(
            this.filterText,
    ...
    isValid(record:DelegatedUserListDto){
        return moment().isSameOrBefore(record.toDate,'day');
    }
