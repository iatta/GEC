...
using Pixel.Attendance.Web.Areas.App.Models.Webhooks;
using Pixel.Attendance.Web.Controllers;
using Pixel.Attendance.WebHooks;
...
namespace Pixel.Attendance.Web.Areas.App.Controllers
{
    ...
    public class WebhookSubscriptionController : AttendanceControllerBase
    {
