...
using Pixel.Attendance.Authorization.Accounts;
...
using Pixel.Attendance.Web.Models.Account;
using Pixel.Attendance.Security;
using Pixel.Attendance.Security.Recaptcha;
using Pixel.Attendance.Sessions;
using Pixel.Attendance.Url;
using Pixel.Attendance.Web.Authentication.External;
using Pixel.Attendance.Web.Security.Recaptcha;
using Pixel.Attendance.Web.Session;
using Pixel.Attendance.Web.Views.Shared.Components.TenantChange;

namespace Pixel.Attendance.Web.Controllers
{
    public class AccountController : AttendanceControllerBase
    {
