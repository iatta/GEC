...
using MvvmHelpers;
using Pixel.Attendance.Authorization.Users.Profile;
using Pixel.Attendance.Authorization.Users.Profile.Dto;
using Pixel.Attendance.Commands;
using Pixel.Attendance.Core.Threading;
using Pixel.Attendance.Models.NavigationMenu;
using Pixel.Attendance.Services.Navigation;
using Pixel.Attendance.ViewModels.Base;
using Plugin.Media;
...
using Pixel.Attendance.ApiClient;
using Pixel.Attendance.Controls;
using Pixel.Attendance.Dto;
using Pixel.Attendance.Extensions;
using Pixel.Attendance.Localization;
using Pixel.Attendance.UI;
using Pixel.Attendance.UI.Assets;
using Pixel.Attendance.Views;
using DependencyResolver = Pixel.Attendance.Core.Dependency.DependencyResolver;

namespace Pixel.Attendance.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Attendance";
