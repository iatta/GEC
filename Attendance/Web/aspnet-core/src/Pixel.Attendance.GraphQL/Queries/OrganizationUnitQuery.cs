...
using Pixel.Attendance.Core.Base;
using Pixel.Attendance.Core.Extensions;
using Pixel.Attendance.Dto;
using Pixel.Attendance.Types;

namespace Pixel.Attendance.Queries
{
    public class OrganizationUnitQuery : AttendanceQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
