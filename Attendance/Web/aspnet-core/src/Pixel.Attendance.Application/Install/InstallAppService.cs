...
using Pixel.Attendance.Migrations.Seed.Host;
...
namespace Pixel.Attendance.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : AttendanceAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<AttendanceDbContext> _migrator;
