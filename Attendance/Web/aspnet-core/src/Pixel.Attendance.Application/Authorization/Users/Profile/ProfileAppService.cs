...
using Pixel.Attendance.Timing;

namespace Pixel.Attendance.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : AttendanceAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Pixel.Attendance",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Pixel.Attendance",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
        ...
        public async Task ChangePassword(ChangePasswordInput input)
        {
            ...
            {
                user.MobilePassword = EnryptString(input.NewPassword);
