...
using Pixel.Attendance.Auditing.Exporting;
using Pixel.Attendance.Authorization;
using Pixel.Attendance.Authorization.Users;
using Pixel.Attendance.Dto;
using Pixel.Attendance.EntityHistory;
using EntityHistoryHelper = Pixel.Attendance.EntityHistory.EntityHistoryHelper;

namespace Pixel.Attendance.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : AttendanceAppServiceBase, IAuditLogAppService
    {
