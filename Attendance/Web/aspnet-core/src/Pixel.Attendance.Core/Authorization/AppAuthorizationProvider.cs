...
namespace Pixel.Attendance.Authorization
{
    ...
    public class AppAuthorizationProvider : AuthorizationProvider
    {
        ...
        public override void SetPermissions(IPermissionDefinitionContext context)
        {
            ...
            transactionLogs.CreateChildPermission(AppPermissions.Pages_TransactionLogs_Delete, L("DeleteTransactionLog"));



            var overrideShifts = pages.CreateChildPermission(AppPermissions.Pages_OverrideShifts, L("OverrideShifts"));
            overrideShifts.CreateChildPermission(AppPermissions.Pages_OverrideShifts_Create, L("CreateNewOverrideShift"));
            overrideShifts.CreateChildPermission(AppPermissions.Pages_OverrideShifts_Edit, L("EditOverrideShift"));
            overrideShifts.CreateChildPermission(AppPermissions.Pages_OverrideShifts_Delete, L("DeleteOverrideShift"));
            ...
            organizationLocations.CreateChildPermission(AppPermissions.Pages_OrganizationLocations_Delete, L("DeleteOrganizationLocation"));



            var projectLocations = pages.CreateChildPermission(AppPermissions.Pages_ProjectLocations, L("ProjectLocations"));
            projectLocations.CreateChildPermission(AppPermissions.Pages_ProjectLocations_Create, L("CreateNewProjectLocation"));
            projectLocations.CreateChildPermission(AppPermissions.Pages_ProjectLocations_Edit, L("EditProjectLocation"));
            projectLocations.CreateChildPermission(AppPermissions.Pages_ProjectLocations_Delete, L("DeleteProjectLocation"));
            ...
            var managerReport = pages.CreateChildPermission(AppPermissions.Pages_ManagerReport, L("ManagerReport"));
            var hrReport = pages.CreateChildPermission(AppPermissions.Pages_HrReport, L("HrReport"));
