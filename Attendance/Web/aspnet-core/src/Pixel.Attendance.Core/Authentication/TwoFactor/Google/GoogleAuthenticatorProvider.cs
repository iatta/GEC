...
namespace Pixel.Attendance.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : AttendanceServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Pixel.Attendance", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
